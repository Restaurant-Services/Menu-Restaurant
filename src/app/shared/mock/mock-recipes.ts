...
export const RECIPES: Recipe[] = [
  ...
  new Recipe(73,  '67', 'Ebi teriyaki', RECIPE_TYPES[5],
    ...
    6.0, 2, [22],
    [3, 4, 11, 15, 1]),
  new Recipe(74,  '68', 'Ebi tempura', RECIPE_TYPES[6],
    'Gamberi in tempura',
    6.0, 3, [],
    [3, 11, 6, 13, 15, 1]),
  new Recipe(75,  '69', 'Mandorle ebi tempura', RECIPE_TYPES[6],
    'Gamberi in crosta di mandorle',
    9.0, 3, [],
    [3, 11, 6, 7, 13, 15, 1]),
  new Recipe(76,  '70', 'Yasai tempura', RECIPE_TYPES[6],
    'Verdure stagionali in tempura',
    5.0, 4, [],
    [2, 3, 6, 1]),
  new Recipe(77,  '71', 'Tempura mix', RECIPE_TYPES[6],
    'Gamberi e Verdure stagionali in tempura',
    9.0, null, [],
    [2, 3, 6, 11, 13, 15, 1]),
  new Recipe(78,  '72', 'Ika tempura', RECIPE_TYPES[6],
    'Anello di calamari in panko',
    6.0, null, [],
    [3, 6, 13, 15, 1]),
  new Recipe(79,  '73', 'Tori karage', RECIPE_TYPES[6],
    'Bocconcini di pollo fritto',
    6.0, null, [],
    [3, 6]),
  new Recipe(80,  '74', 'Chicken furai', RECIPE_TYPES[6],
    'Cotoletta di pollo in panko',
    5.0, null, [],
    [3, 6]),
  new Recipe(81,  '75', 'Potato furai', RECIPE_TYPES[6],
    'Patatine fritte',
    3.0, null, [14],
    [2, 15, 0]),
  new Recipe(82,  '76', 'Salmon stick', RECIPE_TYPES[6],
    'Stick di salmone in panko',
    6.0, 3, [14],
    [3, 6, 12, 15, 1]),
  new Recipe(83,  '77', 'Pollo alle mandorle', RECIPE_TYPES[7],
    'Pollo alle mandorle',
    5.5, null, [],
    [2, 3, 4, 7]),
  new Recipe(84,  '78', 'Pollo al limone', RECIPE_TYPES[7],
    'Pollo al limone',
    5.5, null, [],
    [2]),
  new Recipe(85,  '79', 'Pollo all\'arancia', RECIPE_TYPES[7],
    'Pollo all\'arancia',
    5.5, null, [],
    [2]),
  new Recipe(86,  '80', 'Pollo piccante', RECIPE_TYPES[7],
    'Pollo piccante',
    5.5, null, [],
    [2, 5]),
  new Recipe(87,  '81', 'Pollo al curry', RECIPE_TYPES[7],
    'Pollo al curry',
    5.5, null, [],
    [2, 3]),
  new Recipe(88,  '82', 'Pollo agli anacardi', RECIPE_TYPES[7],
    'Pollo agli anacardi',
    5.5, null, [],
    [2, 3, 7]),
  new Recipe(89,  '83', 'Pollo bambù e funghi', RECIPE_TYPES[7],
    'Pollo bambù e funghi',
    5.5, null, [],
    [2, 4]),
  new Recipe(90,  '84', 'Pollo con verdure miste', RECIPE_TYPES[7],
    'Pollo con verdure miste',
    5.5, null, [],
    [2]),
  new Recipe(91,  '85', 'Pollo in agrodolce', RECIPE_TYPES[7],
    'Pollo in salsa agrodolce',
    5.0, null, [],
    [2]),
  new Recipe(92,  '86', 'Manzo bambù e funghi', RECIPE_TYPES[7],
    'Manzo bambù e funghi',
    6.5, null, [],
    [2, 3, 4]),
  new Recipe(93,  '87', 'Manzo al curry', RECIPE_TYPES[7],
    'Manzo al curry',
    7.0, null, [],
    [2, 3, 4]),
  new Recipe(94,  '88', 'Manzo in salsa d\'ostriche', RECIPE_TYPES[7],
    'Manzo in salsa d\'ostriche',
    7.0, null, [],
    [2, 3, 4, 13]),
  new Recipe(95,  '89', 'Manzo patate e verdure', RECIPE_TYPES[7],
    'Manzo con patate e verdure',
    7.0, null, [],
    [2, 3, 4]),
  new Recipe(96,  '90', 'Maiale in agrodolce', RECIPE_TYPES[7],
    'Maiale in salsa agrodolce',
    6.0, null, [],
    [2, 10]),
  /**/
  new Recipe(105,  '91', 'Calamari piccanti', RECIPE_TYPES[8],
    'Calamari piccanti',
    6.0, null, [],
    [2, 13, 5, 15]),
  new Recipe(97,  '92', 'Gamberi sale e pepe', RECIPE_TYPES[8],
    'Gamberi sale e pepe',
    7.5, null, [14],
    [2, 11, 15]),
  new Recipe(98,  '93', 'Gamberi al curry', RECIPE_TYPES[8],
    'Gamberi al curry',
    7.5, null, [],
    [2, 11, 15]),
  new Recipe(99,  '94', 'Gamberi piccanti', RECIPE_TYPES[8],
    'Gamberi piccanti',
    7.5, null, [],
    [2, 11, 5, 15]),
  new Recipe(100,  '95', 'Gamberi al limone', RECIPE_TYPES[8],
    'Gamberi al limone',
    8.0, null, [],
    [2, 11, 15]),
  new Recipe(101,  '96', 'Gamberi all\'arancia', RECIPE_TYPES[8],
    'Gamberi all\'arancia',
    8.0, null, [],
    [2, 11, 15]),
  new Recipe(102,  '97', 'Gamberi in agrodolce', RECIPE_TYPES[8],
    'Gamberi in salsa agrodolce',
    7.5, null, [],
    [2, 11, 15]),
  new Recipe(103,  '98', 'Gamberi fritti', RECIPE_TYPES[8],
    'Gamberi fritti',
    8.0, null, [],
    [3, 6, 11, 15]),
  new Recipe(104,  '99', 'Gamberi bambù e funghi', RECIPE_TYPES[8],
    'Gamberi con bambù e funghi',
    7.5, null, [],
    [2, 3, 11, 15]),
  new Recipe(106,  '100', 'Germogli di soia al wok', RECIPE_TYPES[9],
    'Germogli di soia al wok',
    5.5, null, [],
    [2, 0]),
  new Recipe(107,  '101', 'Verdure di stagione al wok', RECIPE_TYPES[9],
    'Verdure di stagione al wok',
    5.5, null, [],
    [2, 0]),
  new Recipe(108,  '110', 'Poke sake', RECIPE_TYPES[10],
    'Riso con salmone, avocado, edamame, cipolle fritte e sesamo',
    12.0, null, [2, 5, 4, 23],
    [2, 3, 12, 14, 1]),
  new Recipe(109,  '111', 'Poke ebiten', RECIPE_TYPES[10],
    'Riso con tempura di gamberi, avocado, edamame e wakame',
    11.0, null, [2, 5, 27],
    [2, 3, 4, 6, 11, 15, 1]),
  new Recipe(110,  '112', 'Poke special ZUMI', RECIPE_TYPES[10],
    'Riso con salmone, tonno, edamame, mandorle, avocado, surimi e ikura',
    13.0, null, [5, 11, 2, 24, 8],
    [2, 3, 4, 7, 11, 12, 13, 15, 14, 1]),
  new Recipe(111,  '113', 'Poke vegan', RECIPE_TYPES[10],
    'Riso con avocado, mango, wakame, edamame e cetriolo',
    9.0, null, [2, 12, 27, 5, 3],
    [2, 0]),
  new Recipe(112,  '114', 'Tacos sake', RECIPE_TYPES[11],
    'Taco con salmone marinato, guacamole e cipolla fritta',
    6.0, 1, [6, 4],
    [2, 3, 4, 12, 14, 1]),
  new Recipe(113,  '115', 'Tacos ebiten', RECIPE_TYPES[11],
    'Taco con gambero in tempura, philadelphia e insalta',
    6.0, 1, [15, 22],
    [2, 3, 4, 6, 9, 11, 15, 1]),
  new Recipe(114,  '102', 'Hoso sake', RECIPE_TYPES[12],
    'Hosomaki al salmone',
    4.0, 6, [],
    [12, 15, 1]),
  new Recipe(115,  '103', 'Hoso tekka', RECIPE_TYPES[12],
    'Hosomaki al tonno',
    4.0, 6, [],
    [12, 15, 1]),
  new Recipe(116,  '104', 'Hoso ebi', RECIPE_TYPES[12],
    'Hosomaki al gambero cotto',
    3.5, 6, [],
    [11, 15, 1]),
  new Recipe(117,  '105', 'Hoso sake flower', RECIPE_TYPES[12],
    'Hosomaki al salmone cotto e philadelphia',
    4.0, 6, [],
    [3, 4, 9, 12, 15, 1]),
  new Recipe(118,  '106', 'Hoso kani', RECIPE_TYPES[12],
    'Hosomaki al granchio',
    3.5, 6, [],
    [3, 11, 13, 15, 1]),
  new Recipe(119,  '107', 'Hoso mango', RECIPE_TYPES[12],
    'Hosomaki al mango',
    3.5, 6, [],
    [2, 0]),
  new Recipe(120,  '108', 'Hoso avocado', RECIPE_TYPES[12],
    'Hosomaki all\'avocado',
    3.5, 6, [],
    [2, 0]),
  new Recipe(121,  '109', 'Hoso kappa', RECIPE_TYPES[12],
    'Hosomaki al cetriolo',
    3.0, 6, [],
    [2, 0]),
  new Recipe(122,  '116', 'Sake avocado roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con avocado ricoperto di sesamo',
    4.5, 4, [23],
    [2, 12, 14, 1]),
  new Recipe(123,  '117', 'Maguro avocado roll', RECIPE_TYPES[13],
    'Hosomaki al tonno con avocado ricoperto di sesamo',
    4.5, 4, [23],
    [2, 12, 14, 1]),
  new Recipe(124,  '118', 'Spice sake roll', RECIPE_TYPES[13],
    'Hosomaki al salmone piccante',
    4.5, 4, [],
    [3, 6, 5, 12, 14, 1]),
  new Recipe(125,  '119', 'Spice tuna roll', RECIPE_TYPES[13],
    'Hosomaki al tonno piccante',
    4.5, 4, [],
    [3, 6, 5, 12, 14, 1]),
  new Recipe(126,  '120', 'Philadelphia roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con philadelphia e avocado ricoperto di tobiko',
    4.5, 4, [25],
    [2, 9, 12, 13, 14, 15, 1]),
  new Recipe(127,  '121', 'Rainbow roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con avocado ricoperto di pesce misto',
    6.0, 4, [],
    [2, 12, 14, 1]),
  new Recipe(128,  '122', 'Mexican roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con philadelphia, guacamole e nachos',
    6.5, 4, [],
    [2, 3, 9, 12, 14, 1]),
  new Recipe(129,  '123', 'Wasabi roll', RECIPE_TYPES[13],
    'Hosomaki di spigola con avocado e maionese al wasabi',
    6.0, 4, [9],
    [2, 6, 5, 12, 14, 1]),
  new Recipe(130,  '124', 'Tris roll', RECIPE_TYPES[13],
    'Hosomaki con salmone, tonno e spigola ricoperto di cipolla fritta',
    6.5, 4, [4],
    [3, 12, 14, 1]),
  new Recipe(131,  '125', 'Lime roll', RECIPE_TYPES[13],
    'Hosomaki al salmone piccante ricoperto di lime con salsa al tabasco',
    6.0, 4, [21],
    [2, 6, 5, 12, 14, 1]),
  new Recipe(132,  '126', 'Wakame roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con avocado, ricoperto di wakame e salsa al sesamo',
    6.0, 4, [20],
    [2, 12, 14, 15, 1]),
  new Recipe(133,  '127', 'Ginger roll', RECIPE_TYPES[13],
    'Hosomaki al surimi in tempura ricoperto di zenzero marinato',
    5.5, 4, [],
    [2, 3, 6, 11, 13, 15, 1]),
  new Recipe(134,  '128', 'Pistacchio tuna roll', RECIPE_TYPES[13],
    'Hosomaki al tonno con avocado ricoperto di granella di pistacchio e maionese',
    6.5, 4, [9],
    [2, 6, 7, 12, 14, 1]),
  new Recipe(135,  '129', 'Tropical roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con avocado ricoperto di mango e passion fruit',
    6.5, 4, [],
    [2, 12, 14, 1]),
  new Recipe(136,  '129VEG', 'Tropical vegan roll', RECIPE_TYPES[13],
    'Hosomaki con avocado ricoperto di mango e passion fruit',
    6.0, 4, [],
    [2, 0]),
  new Recipe(137,  '130', 'Green tuna roll', RECIPE_TYPES[13],
    'Hosomaki al tonno con philadelphia e mela verde',
    6.5, 4, [],
    [2, 9, 12, 14, 1]),
  new Recipe(138,  '131', 'Fragola roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con philadelphia e fragole',
    6.0, 4, [22],
    [2, 3, 4, 9, 12, 14, 1]),
  new Recipe(139,  '132', 'Mango roll', RECIPE_TYPES[13],
    'Hosomaki al salmone con philadelphia e mango',
    6.0, 4, [22],
    [2, 3, 4, 9, 12, 14, 1]),
  new Recipe(140,  '133', 'Felice roll', RECIPE_TYPES[13],
    'Hosomaki al salmone fritto e philadelphia ricoperto di salmone',
    5.5, 4, [22],
    [3, 4, 9, 6, 12, 14, 1]),
  new Recipe(141,  '134', 'Tartar roll', RECIPE_TYPES[13],
    'Hosomaki alle verdure fritte ricoperto di tartar al salmone',
    5.0, 4, [21, 18],
    [2, 3, 6, 5, 12, 14, 1]),
  new Recipe(142,  '135', 'Shibuya roll', RECIPE_TYPES[13],
    'Hosomaki al gambero fritto con philadelphia ricoperto di salmone e avocado',
    6.0, 4, [21],
    [2, 3, 4, 6, 9, 11, 12, 14, 15, 1]),
  new Recipe(143,  '136', 'Miura roll', RECIPE_TYPES[13],
    'Hosomaki al salmone cotto con philadelphia e avocado ricoperto di kataifi',
    4.5, 4, [22],
    [2, 3, 4, 9, 12, 14, 1]),
  new Recipe(144,  '137', 'California roll', RECIPE_TYPES[13],
    'Hosomaki al surimi con cetriolo e avocado',
    4.5, 4, [],
    [2, 3, 11, 13, 15, 1]),
  new Recipe(145,  '138', 'California special', RECIPE_TYPES[13],
    'Hosomaki al tonno in scatola, maionese, surimi e avocado',
    4.5, 4, [9],
    [2, 3, 6, 11, 12, 13, 15, 1]),
  new Recipe(146,  '139', 'Ebiten roll', RECIPE_TYPES[13],
    'Hosomaki al gambero fritto ricoperto di kataifi',
    5.0, 4, [22],
    [3, 4, 6, 11, 15, 1]),
  new Recipe(147,  '140', 'Tiger roll', RECIPE_TYPES[13],
    'Hosomaki al gambero fritto ricoperto di salmone flambè',
    5.5, 4, [22],
    [3, 4, 6, 11, 15, 1]),
  new Recipe(148,  '141', 'Dragon roll', RECIPE_TYPES[13],
    'Hosomaki al gambero fritto ricoperto di avocado',
    5.5, 4, [22],
    [2, 3, 4, 6, 9, 11, 15, 1]),
  new Recipe(149,  '142', 'Rucola roll', RECIPE_TYPES[13],
    'Hosomaki al gambero fritto ricoperto di salone flambè e rucola',
    5.5, 4, [22],
    [2, 3, 4, 6, 11, 12, 14, 15, 1]),
  new Recipe(150,  '143', 'Unaghi roll', RECIPE_TYPES[13],
    'Hosomaki con anguilla e philadelphia ricoperto di avocado',
    6.0, 4, [22, 15],
    [2, 3, 4, 9, 13, 15, 1]),
  new Recipe(151,  '144', 'Mandorle roll', RECIPE_TYPES[13],
    'Hosomaki con pollo fritto ricoperto di mandorle',
    5.0, 4, [22, 11],
    [3, 4, 6, 7]),
  new Recipe(152,  '145', 'Vegan roll', RECIPE_TYPES[13],
    'Hosomaki con cetriolo, avocado e mango',
    4.0, 4, [22, 11],
    [2, 0]),
  new Recipe(153,  '146', 'Maki fritto', RECIPE_TYPES[13],
    'Hosomaki con salmone, philadelphia e frutta di stagione',
    6.5, 6, [22, 15],
    [2, 3, 4, 6, 9, 12, 1]),
  new Recipe(154,  '147', 'Futomaki fritto', RECIPE_TYPES[13],
    'Hosomaki con salmone, tonno, surimi, cetriolo e avocado',
    7.0, 6, [22],
    [2, 3, 4, 6, 11, 12, 13, 14, 15, 1]),
  new Recipe(155,  'V1', 'Black venere philadelphia', RECIPE_TYPES[13],
    'Hosomaki al salmone con philadelphia e avocado ricoperto di tobiko',
    6.0, 4, [15, 2],
    [2, 9, 12, 13, 14, 15, 1]),
  new Recipe(155,  'V2', 'Black venere miura', RECIPE_TYPES[13],
    'Hosomaki al salmone cotto con philadelphia e avocado ricoperto di kataifi',
    5.5, 4, [15, 2, 22],
    [2, 3, 4, 9, 12, 13, 14, 15, 1]),
  new Recipe(156,  'V3', 'Black venere ebiten', RECIPE_TYPES[13],
    'Hosomaki al gambero fritto e kataifi',
    6.0, 4, [22],
    [3, 4, 6, 11, 15, 1]),
  new Recipe(157,  'V4', 'Black venere sake e avocado', RECIPE_TYPES[13],
    'Hosomaki al salmone con avocado e sesamo',
    5.5, 4, [2, 23],
    [2, 12, 14, 1]),
  new Recipe(158,  'V5', 'Black venere maguro e avocado', RECIPE_TYPES[13],
    'Hosomaki al tonno con avocado e sesamo',
    5.5, 4, [2, 23],
    [2, 12, 14, 1]),
  new Recipe(159,  '148', 'Nigiri sake', RECIPE_TYPES[14],
    'Nigiri al salmone',
    2.5, 2, [],
    [12, 14, 1]),
  new Recipe(160,  '149', 'Nigiri maguro', RECIPE_TYPES[14],
    'Nigiri al tonno',
    2.5, 2, [],
    [12, 14, 1]),
  new Recipe(161,  '150', 'Nigiri amaebi', RECIPE_TYPES[14],
    'Nigiri al gambero crudo',
    3.0, 2, [],
    [11, 13, 15, 1]),
  new Recipe(162,  '151', 'Nigiri ebi', RECIPE_TYPES[14],
    'Nigiri al gambero cotto',
    2.5, 2, [],
    [11, 15, 1]),
  new Recipe(163,  '152', 'Nigiri tako', RECIPE_TYPES[14],
    'Nigiri al polpo cotto',
    2.5, 2, [],
    [13, 15, 1]),
  new Recipe(164,  '153', 'Nigiri unaghi', RECIPE_TYPES[14],
    'Nigiri all\'anguilla',
    2.5, 2, [22],
    [3, 4, 13, 15, 1]),
  new Recipe(165,  '154', 'Nigiri mango', RECIPE_TYPES[14],
    'Nigiri al mango',
    2.5, 2, [],
    [0]),
  new Recipe(166,  '155', 'Nigiri avocado', RECIPE_TYPES[14],
    'Nigiri all\'avocado',
    2.5, 2, [],
    [0]),
  new Recipe(167,  '156', 'Nigiri sake flower', RECIPE_TYPES[14],
    'Nigiri al salmone scottato e philadelphia',
    3.5, 2, [15, 22],
    [3, 4, 9, 12, 14, 1]),
  new Recipe(168,  '157', 'Onigiri sake', RECIPE_TYPES[15],
    'Onigiri al salmone',
    3.0, 1, [],
    [12, 14, 1]),
  new Recipe(169,  '158', 'Onigiri special maguro', RECIPE_TYPES[15],
    'Onigiri al tonno in scatola e maionese',
    3.0, 1, [26, 9],
    [6, 12, 1]),
  new Recipe(170,  '159', 'Onigiri ebi', RECIPE_TYPES[15],
    'Onigiri al gambero cotto',
    3.0, 1, [26, 9],
    [11, 15, 1]),
  new Recipe(171,  '160', 'Sake temaki', RECIPE_TYPES[16],
    'Temaki al salmone con avocado',
    3.5, 1, [2],
    [2, 12, 14, 1]),
  new Recipe(172,  '161', 'Maguro temaki', RECIPE_TYPES[16],
    'Temaki al tonno con avocado',
    3.5, 1, [2],
    [2, 12, 14, 1]),
  new Recipe(173,  '162', 'Ebiten temaki', RECIPE_TYPES[16],
    'Temaki al gambero fritto con avocado',
    3.5, 1, [2, 22],
    [2, 3, 4, 6, 11, 15, 1]),
  new Recipe(174,  '163', 'Ebiten temaki', RECIPE_TYPES[16],
    'Temaki al gambero cotto con avocado',
    3.5, 1, [2],
    [2, 11, 15, 1]),
  new Recipe(175,  '164', 'Spicy sake temaki', RECIPE_TYPES[16],
    'Temaki al salmone piccante con avocado',
    3.5, 1, [2],
    [2, 5, 6, 12, 14, 1]),
  new Recipe(176,  '165', 'Spicy maguro temaki', RECIPE_TYPES[16],
    'Temaki al tonno piccante con avocado',
    3.5, 1, [2],
    [2, 5, 6, 12, 14, 1]),
  new Recipe(177,  '166', 'Philadelphia temaki', RECIPE_TYPES[16],
    'Temaki al salmone e philadelphia con avocado',
    4.0, 1, [2],
    [2, 6, 12, 14, 1]),
  new Recipe(178,  '167', 'Vegan temaki', RECIPE_TYPES[16],
    'Temaki al cetriolo, avocado e mango',
    3.5, 1, [],
    [2, 0]),
  new Recipe(179,  '168', 'Chirashi sake', RECIPE_TYPES[17],
    'Cupola di riso ricoperta di salmone',
    7.0, 1, [],
    [12, 14, 1]),
  new Recipe(180,  '169', 'Chirashi mix', RECIPE_TYPES[17],
    'Cupola di riso ricoperta di salmone e tonno',
    7.5, 1, [],
    [12, 14, 1]),
  new Recipe(181,  '170', 'Sashimi sake', RECIPE_TYPES[18],
    'Sashimi di salmone',
    5.0, 5, [],
    [12, 14, 1]),
  new Recipe(182,  '171', 'Sashimi tai', RECIPE_TYPES[18],
    'Sashimi di spigola',
    5.0, 5, [],
    [12, 14, 1]),
  new Recipe(183,  '172', 'Sashimi maguro', RECIPE_TYPES[18],
    'Sashimi di tonno',
    6.0, 5, [],
    [12, 14, 1]),
  new Recipe(184,  '173', 'Sashimi mix', RECIPE_TYPES[18],
    'Sashimi misto',
    12.0, 13, [],
    [12, 14, 1]),
  new Recipe(185,  '174', 'Tartare sake', RECIPE_TYPES[8],
    'Tartare di salmone marinato con mango e avocado',
    8.0, null, [],
    [2, 3, 4, 12, 14, 1]),
  new Recipe(186,  '175', 'Tartare maguro', RECIPE_TYPES[8],
    'Tartare di tonno marinato con mango e avocado',
    8.5, null, [],
    [2, 3, 4, 12, 14, 1]),
  new Recipe(187,  '176', 'Tartare sake venerde', RECIPE_TYPES[8],
    'Tartare di salmone marinato su letto di riso venere',
    10.0, null, [],
    [2, 12, 14, 1]),
  new Recipe(188,  '177', 'Carpaccio di salmone', RECIPE_TYPES[8],
    'Carpaccio di salmone marinato in salsa di agrumi',
    8.0, 10, [],
    [3, 4, 12, 14, 1]),
  new Recipe(189,  '178', 'Carpaccio mix', RECIPE_TYPES[8],
    'Carpaccio di pesce misto marinato in salsa di agrumi',
    10.0, 12, [],
    [3, 4, 12, 14, 1]),
  new Recipe(190,  '179', 'Carpaccio Zumi', RECIPE_TYPES[8],
    'Carpaccio di salmone e gamberetti marinati in salsa ponzu con cipollina e olio',
    11.0, 10, [],
    [2, 3, 4, 11, 12, 14, 15, 1]),
  new Recipe(191,  '180', 'Philadelphia gunkan', RECIPE_TYPES[19],
    'Gunkan al salmone e philadelphia',
    3.5, 2, [],
    [9, 12, 14, 1]),
  new Recipe(192,  '181', 'Sake gunkan', RECIPE_TYPES[19],
    'Gunkan al salmone con tartare di salmone',
    3.5, 2, [21],
    [6, 5, 12, 14, 1]),
  new Recipe(193,  '182', 'Guacamole gunkan', RECIPE_TYPES[19],
    'Gunkan al salmone con guacamole',
    3.5, 2, [],
    [2, 12, 14, 1]),
  new Recipe(194,  '183', 'Ikura gunkan', RECIPE_TYPES[19],
    'Gunkan con uova di salmone',
    4.0, 2, [],
    [13, 15, 1]),
  new Recipe(195,  '184', 'Tobiko gunkan', RECIPE_TYPES[19],
    'Gunkan con uova di pesce volante',
    3.5, 2, [],
    [13, 15, 1]),
  new Recipe(196,  '185', 'Maguro gunkan', RECIPE_TYPES[19],
    'Gunkan al tonno con tartare di tonno',
    3.5, 2, [],
    [6, 5, 12, 14, 1]),
  new Recipe(197,  '186', 'Wakame gunkan', RECIPE_TYPES[19],
    'Gunkan con wakame',
    3.5, 2, [],
    [2, 15, 1]),
  new Recipe(198,  '187', 'Nigiri misto', RECIPE_TYPES[20],
    'Nigiri assortiti',
    7.0, 6, [],
    []),
  new Recipe(199,  '188', 'Sushi mix small', RECIPE_TYPES[20],
    '4 nigiri, 2 uramaki e 2 hosomaki assortiti',
    8.0, 8, [],
    []),
  new Recipe(200,  '189', 'Sushi mix single', RECIPE_TYPES[20],
    '16 pezzi assortiti fra nigiri, uramaki, hosomaki e sashimi',
    16.0, 16, [],
    []),
  new Recipe(201,  '190', 'Sushi mix double', RECIPE_TYPES[20],
    '32 pezzi misti fra nigiri, uramaki, hosomaki e sashimi, serviti al tavolo in una barca',
    32.0, 32, [],
    []),
  new Recipe(202,  '191', 'Sushi mix family', RECIPE_TYPES[20],
    '54 pezzi misti fra nigiri, uramaki, hosomaki e sashimi, serviti al tavolo in una barca',
    54.0, 54, [],
    []),
  new Recipe(203,  'D1', 'Dorayaki', RECIPE_TYPES[21],
    'Il famoso dolce di Doraemon, pancake Giapponesi ripieno di nutella',
    6.0, null, [13],
    []),
  new Recipe(204,  'D2', 'Mochi', RECIPE_TYPES[21],
    'Dolce di riso ripieno al gelato',
    5.0, null, [],
    []),
  new Recipe(205,  'D3', 'Tiramisù verde', RECIPE_TYPES[21],
    'Variante Giapponese del Tiramisù nostrano',
    6.0, null, [],
    []),
  new Recipe(206,  'D4', 'Tiramisù alla nutella', RECIPE_TYPES[21],
    'Variante della casa del Tiramisù con aggiunta di Nutella',
    6.0, null, [],
    []),
  new Recipe(207,  'D5', 'Daifuku', RECIPE_TYPES[21],
    'Dolce di riso con ripieno ai fagioli rossi',
    5.0, null, [],
    []),
  new Recipe(208,  'D6', 'Soufflé al cioccolato', RECIPE_TYPES[21],
    'Soufflé al cioccolato',
    5.5, null, [13],
    []),
  new Recipe(209,  'D7', 'Nutella maki', RECIPE_TYPES[21],
    'Maki ricreati con crepe ripiena al gelato con nutella, panna e scaglie di cocco',
    6.5, null, [13],
    []),
  new Recipe(210,  'D8', 'Gelato giapponese bigusto', RECIPE_TYPES[21],
    'Tè verde, sesamo, zenzero e riso',
    4.0, null, [],
    []),
  new Recipe(211,  'D9', 'Sorbetto al limone', RECIPE_TYPES[21],
    'Sorbetto al limone',
    3.5, null, [],
    []),
  new Recipe(212,  'D10', 'Creme brulèe', RECIPE_TYPES[21],
    'Creme brulèe',
    5.0, null, [],
    []),
  new Recipe(213,  'D11', 'Cheesecake fredda', RECIPE_TYPES[21],
    'Gusto a scelta',
    6.0, null, [13],
    []),
  new Recipe(214,  null, 'Acqua', RECIPE_TYPES[22],
    '750 ml',
    2.0, null, [],
    []),
  new Recipe(215,  null, 'Acqua', RECIPE_TYPES[22],
    '500 ml',
    1.5, null, [],
    []),
  new Recipe(216,  null, 'Coca cola', RECIPE_TYPES[22],
    '330 ml',
    2.5, null, [],
    []),
  new Recipe(217,  null, 'Coca cola zero', RECIPE_TYPES[22],
    '330 ml',
    2.5, null, [],
    []),
  new Recipe(218,  null, 'Coca cola', RECIPE_TYPES[22],
    ...
    4.0, null, [],
    []),
  new Recipe(219,  null, 'Fanta', RECIPE_TYPES[22],
    '330 ml',
    2.5, null, [],
    []),
  new Recipe(220,  null, 'Sprite', RECIPE_TYPES[22],
    '330 ml',
    2.5, null, [],
    []),
  new Recipe(221,  null, 'Tè al limone', RECIPE_TYPES[22],
    '330 ml',
    2.5, null, [],
    []),
  new Recipe(222,  null, 'Tè alla pesca', RECIPE_TYPES[22],
    '330 ml',
    2.5, null, [],
    []),
  new Recipe(223,  null, 'Tè verde caldo', RECIPE_TYPES[22],
    'Preparato da noi',
    3.5, null, [],
    []),
  new Recipe(224,  null, 'Tè al gelsomino caldo', RECIPE_TYPES[22],
    'Preparato da noi',
    3.5, null, [],
    []),
  new Recipe(225,  null, 'Birra Asahi', RECIPE_TYPES[22],
    '330 ml',
    4.0, null, [],
    []),
  new Recipe(226,  null, 'Birra Asahi', RECIPE_TYPES[22],
    '500 ml',
    5.0, null, [],
    []),
  new Recipe(227,  null, 'Birra Sapporo', RECIPE_TYPES[22],
    '650 ml',
    6.0, null, [],
    []),
  new Recipe(228,  null, 'Birra Sapporo', RECIPE_TYPES[22],
    '650 ml',
    6.0, null, [],
    []),
  new Recipe(228,  null, 'Birra Tsingtao', RECIPE_TYPES[22],
    '640 ml',
    5.5, null, [],
    []),
  new Recipe(229,  null, 'Birra Heineken', RECIPE_TYPES[22],
    '660 ml',
    4.5, null, [],
    [])
